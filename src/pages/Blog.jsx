...
export default function Blog({ blog }) {
  ...
  console.log(singleBlog)
   let srcImg = "https://images.unsplash.com/photo-1682685797741-f0213d24418c?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxlZGl0b3JpYWwtZmVlZHwxNnx8fGVufDB8fHx8fA%3D%3D"
  // if (singleBlog.blog.blogImage) {
  //   srcImg = `${basePath}${blogImage.slice(1)}`
  // }
        ...
        <main className="blog-container">
          <section className="blog-container-top">
            <header className="blog-header">
              ...
              <img
                src="https://images.unsplash.com/photo-1682685797741-f0213d24418c?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxlZGl0b3JpYWwtZmVlZHwxNnx8fGVufDB8fHx8fA%3D%3D"
                alt="user-icon"
                className="blog-user-icon"
              />
              <span>{singleBlog.blog.createdBy.userName}</span>
              <p className="blog-date">{singleBlog.blog.createdAt}</p>
              <div className="blog-like-comment-container">
                <p className="blog-like-comment">{ singleBlog.blog.likes.length }</p>
            ...
            <div className="blog-comment-like-section">
              <div className="blog-sub-container">
                ...
                <div className="blog-sum-container-item-1">
                  <span className="blog-add-like">{singleBlog.blog.likes.length}</span>
                  <img src={like} alt="" className="blog-icon" />
                </div>
              </div>
              <div className="blog-cta">
                <p className="blog-author">Written by {singleBlog.blog.createdBy.userName}</p>
